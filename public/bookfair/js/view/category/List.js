    ...
    initComponent: function() {
        ...
        Ext.apply(me, {
            ...
            columns: [{
                    ...
                    renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                        var val = "";
                        for (var i = 0; i < record.data.settings.length; i++) {
                            if (record.data.settings[i].allocate || record.data.settings[i].track) {
                                val = (val === "" ? record.data.settings[i].season + " Only" : "Multiple");
                            }
                        }                        
                        return val === "" ? "Not used" : val;
                    }
                }
                 /*
                }
You might want a generated column with a renderer to show which bookfair if any this category is for
