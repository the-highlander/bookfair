...
Ext.define('Ext.ux.desktop.Desktop', {
    ...
    initComponent: function () {
        ...
        me.items = [
            { xtype: 'wallpaper', id: me.id+'_wallpaper', path: me.wallpaperPath },
            me.createDataView()
        ];
        ...
        if (wallpaper) {
            me.setWallpaper(wallpaper, me.wallpaperPath, me.wallpaperStretch);
        }
    },
    ...
    createDesktopMenu: function () {
        ...
        ret.items.push(
                ...
                { text: 'Close All', handler: me.closeAllWindows, scope: me, minWindows: 1}
            );
        return ret;
    },
    ...
    closeAllWindows: function() {
        var zmgr = this.getDesktopZIndexManager();
        zmgr.eachBottomUp(function(win) {
            if (win.isWindow) {
                win.doClose();
            }
